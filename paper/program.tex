...
\usepackage{calligra}
\usepackage{setspace}
\usepackage[papersize={4.25in,11in},hmargin=0cm,vmargin={1.5cm,1cm}]{geometry}
...
\begin{document}
  ...
  \begin{center}
    \begin{doublespacing}
      {\block WELCOME TO} \\
      {\block The Wedding Ceremony of} \\
      {\fancy \Large Evan David Oman} \\
      {\fancy \Large \&} \\
      {\fancy \Large Aubrey Johanna Lambert} \\
      {\block On this Day, July 18th, 2015} \\
      % {\fancy to} \\
      % {\block Napoleon} \\
      % {\fancy son of} \\
